    ...
    try {
        if (req.body.address) {
            ...
            request({
                ...
                var tempster = JSON.parse(response.body);
                req.results =
                    {
                        lat: tempster.results[0].geometry.lat,
                        lng: tempster.results[0].geometry.lng
                    };
                //req.results.lat = 
                //req.results.lng = tempster.results[0].geometry.lng;
